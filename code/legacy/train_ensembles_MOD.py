...
if __name__ == "__main__":
    ...
    for training in range(NUM_TRAININGS):
        ...
        dataloader_train = torch.utils.data.DataLoader(
            ...
            batch_size=BATCH_SIZE*N_MEMBERS,
            num_workers=2,
            drop_last=True,
        ...
        for epoch in range(MAX_EPOCHS):
            ...
            for dataloader in [dataloader_train, dataloader_valid]:
                ...
                for x, x_classes, y in tqdm(iter(dataloader)):
                    ...
                    target_loss = loss_fn.forward(y_prim, y.to(DEVICE))
                    if dataloader == dataloader_train:
                        model_ensemble.seperate_batches=False
                        ood_x=noiser.uniform_feature_noise(x.shape,stretch=1e8).to(torch.float32)
                        ...
                        diversity_loss=loss_sep_sha.LossSeperate().forward(ood_ys,ood_y_mean)
